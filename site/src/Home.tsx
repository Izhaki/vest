    ...
    <div>
      ...
      <main>
        ...
        <Section
          ...
          sub="Vest can be extended to support the syntax of Jest, Ava, and the likes."
        ...
        <Section
          title="CI"
          body="Tests run on CI by spinning a headless browser."
          sub="Or use BrowserStack el al."
          img="images/cl.svg"
        ...
        <Section
          ...
          sub="No assertion, stubs, mocks or related API - use existing libraries of choice for these."
